...
public class EnemyMovement : MonoBehaviour
{
    ...
    void CheckScales()
    {
       groundCheckOffsetA = -col.offset - new Vector2(col.size.x / 1.1f - (groundCheckRadius * 1.2f), -col.size.y/ 1.2f);
       groundCheckOffsetB = -col.offset - new Vector2(- col.size.x / 1.1f + (groundCheckRadius * 1.2f), -col.size.y / 1.2f); 

       frontPlayerCol = -col.offset - new Vector2(col.size.x / 1.2f, 0);
       backPlayerCol = -col.offset - new Vector2(-col.size.x / 1.2f, 0);
    }
